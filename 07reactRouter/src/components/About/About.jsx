				...
				<div className='space-y-6 md:space-y-0 md:flex md:gap-6 lg:items-center lg:gap-12'>
					...
					<div className='md:7/12 lg:w-6/12'>
						...
						<p className='mt-6 text-gray-600'>
							Lorem ipsum dolor, sit amet consectetur adipisicing elit. Eum omnis voluptatem accusantium nemo perspiciatis delectus atque autem! Voluptatum tenetur beatae unde aperiam, repellat expedita consequatur! Officiis id consequatur atque
							doloremque!
						</p>
